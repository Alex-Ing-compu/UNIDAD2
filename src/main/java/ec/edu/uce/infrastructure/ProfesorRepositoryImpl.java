...
public class ProfesorRepositoryImpl implements ProfesorRepository{
    ...
    public Profesor seleccionarPorCorreo(String correo) {
       TypedQuery<Profesor> miQuery = this.em.createQuery("SELECT p FROM Profesor p WHERE p.correo = :correo", Profesor.class);
    ...
    public List<Profesor> seleccionarPorEspecialidad(String especialidad) {
        TypedQuery<Profesor> miQuery = this.em.createQuery("SELECT p FROM Profesor p WHERE p.especialidad = :esp", Profesor.class);
    ...
    public List<Profesor> seleccionarPorRangoSalarial(BigDecimal min, BigDecimal max) {
        TypedQuery<Profesor> miQuery = this.em.createQuery("SELECT p FROM Profesor p WHERE p.salario BETWEEN :min AND :max", Profesor.class);
    ...
    public List<Profesor> seleccionarPorPais(String pais) {
       TypedQuery<Profesor> miQuery = this.em.createQuery("SELECT p FROM Profesor p WHERE p.pais = :pais", Profesor.class);
    ...
    public List<Profesor> seleccionarActivos() {
        ...
        TypedQuery<Profesor> miQuery = this.em.createQuery("SELECT p FROM Profesor p WHERE p.estado = true", Profesor.class);
        return miQuery.getResultList();
    }
    ...
    public List<Profesor> seleccionarPorApellidoLike(String texto) {
        ...
        // Concatenamos % al principio y al final para buscar coincidencias en cualquier parte del texto
